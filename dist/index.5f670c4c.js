...
})({"kE4Q7":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
window.addEventListener("load", function() {
    var slider = document.getElementById('slider'), sliderItems = document.getElementById('slides'), prev1 = document.getElementById('prev'), next1 = document.getElementById('next');
    function slide(wrapper, items, prev, next) {
        ...
        function dragStart(e) {
            ...
            if (e.type == 'touchstart') posX1 = e.touches[0].clientX;
            else {
                posX1 = e.clientX;
